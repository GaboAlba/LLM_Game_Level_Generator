namespace PcgBenchmark.BenchmarkPromptTemplates.BenchmarkTemplates.LodeRunnerTile
{
    ...
    public class LodeRunnerEnemiesV0PromptTemplate : LodeRunnerPromptTemplateBase
    {
        [SetsRequiredMembers]
        public LodeRunnerEnemiesV0PromptTemplate(string jsonPath)
            : base(jsonPath)
        {
            ...
            this.LevelName = "loderunner-enemies-v0";
            this.LevelDescription = "";
            this.Tiles = PromptGroundingDataInjector.ListToString(this.GetMapTiles(minEnemies: 12, minGold: 6, targetLadders: this.controlParameters.LaddersCount, targetRopes: this.controlParameters.RopesCount));
            this.Width = "32";
            this.Height = "21";
