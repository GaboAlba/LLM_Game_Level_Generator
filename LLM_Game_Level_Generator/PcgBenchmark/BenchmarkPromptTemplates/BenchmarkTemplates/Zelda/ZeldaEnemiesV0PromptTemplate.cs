namespace PcgBenchmark.BenchmarkPromptTemplates.BenchmarkTemplates.Zelda
{
    ...
    public class ZeldaEnemiesV0PromptTemplate : ZeldaPromptTemplateBase
    {
        [SetsRequiredMembers]
        public ZeldaEnemiesV0PromptTemplate(string jsonPath)
            : base(jsonPath)
        {
            this.GameName = "Zelda";
            ...
            this.LevelName = "zelda-enemies-v0";
            this.LevelDescription = "";
            this.Tiles = PromptGroundingDataInjector.ListToString(this.GetMapTiles(targetEnemies: 12));
            this.Width = "11";
            this.Height = "7";
