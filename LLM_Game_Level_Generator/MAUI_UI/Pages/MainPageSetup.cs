namespace MAUI_UI
{
    ...
    public partial class MainPage
    {
        ...
        private const double BaseOutputFontSize = 20.0;
        ...
        {
            // Approximate monospace character width as 60% of font size
            this.FontProperties.OutputLineHeight = BaseOutputFontSize * this.zoomFactor * 0.6;
        }
    }
}
